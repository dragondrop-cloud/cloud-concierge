...
func (d *IsolatedDragonDrop) AuthorizeJob(_ context.Context) (string, string, error) {
	log.Debug("Authorizing job")
	return "", "", nil
}

// AuthorizeManagedJob Check with DragonDropAPI for valid auth of the current managed job
func (d *IsolatedDragonDrop) AuthorizeManagedJob(_ context.Context) (string, string, string, error) {
	log.Debug("Authorizing job")
	return "", "", "", nil
}
