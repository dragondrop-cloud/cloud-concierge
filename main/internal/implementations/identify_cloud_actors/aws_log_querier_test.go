...
func TestDecimalToUnixTimestamp(t *testing.T) {
	// Given
	inputDecimal := float64(1684419540.0)

	// When
	outputTimestamp := decimalToFormattedTimestamp(inputDecimal)

	// Then
	expectedTimestamp := "2023-05-18"

	if !reflect.DeepEqual(expectedTimestamp, outputTimestamp) {
		t.Errorf("got:\n%v\nexpected:\n%v", outputTimestamp, expectedTimestamp)
	}
}
...
func TestAWSLogQuerier_ExtractDataFromResourceResultManagedByTerraform(t *testing.T) {
    ...
    "Events": [
        {
            "EventId": "929c77ea-c9f8-478f-a458-3c9d3644a78d",
            "EventName": "CreateListener",
            "ReadOnly": "false",
            "AccessKeyId": "ASIAZ54I2ZR37X23RUNJ",
            "EventTime": 1684419540.0,
            "EventSource": "elasticloadbalancing.amazonaws.com",
            "Username": "goodman.benjamin@dragondrop.cloud",
            "Resources": [
                {
                    "ResourceType": "AWS::ElasticLoadBalancingV2::LoadBalancer",
                    "ResourceName": "arn:aws:elasticloadbalancing:us-east-1:682649898103:loadbalancer/app/tf-managed-demo-alb/4c89e21113613302"
                },
                {
                    "ResourceType": "AWS::ElasticLoadBalancingV2::Listener",
                    "ResourceName": "arn:aws:elasticloadbalancing:us-east-1:682649898103:listener/app/tf-managed-demo-alb/4c89e21113613302/2e7801118647d076"
                }
            ],
        ...
        {
            "EventId": "6adee639-a5d2-418a-9d99-60124476e849",
            "EventName": "ModifyLoadBalancerAttributes",
            "ReadOnly": "false",
            "AccessKeyId": "ASIAZ54I2ZR3RUTSUDJG",
            "EventTime": 1684348799.0,
            "EventSource": "elasticloadbalancing.amazonaws.com",
            "Username": "root",
            "Resources": [
                {
...
func TestAWSLogQuerier_ExtractDataFromResourceResultNewToTerraformWithModification(t *testing.T) {
   ...
   "Events": [
       ...
       {
           "EventId": "bcc8056a-6a43-4140-bf54-0348491e634c",
           "EventName": "ModifyLoadBalancerAttributes",
           "ReadOnly": "false",
           "AccessKeyId": "ASIAZ54I2ZR3RUTSUDJG",
           "EventTime": 1684330853.0,
           "EventSource": "elasticloadbalancing.amazonaws.com",
           "Username": "root",
           "Resources": [
               {
